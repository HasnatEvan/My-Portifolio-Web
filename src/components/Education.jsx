        ...
        <div className="space-y-6">
          {[
            ...
            },
            {
              ...
              year: "(2021 - 2025)",
              desc: "Currently pursuing a Diploma in Engineering in the field of Computer Science and Communication.",
            },
            {
            ...
            <motion.div
              key={i}
              className="border-l-4 border-[#C6FF00] pl-4"
            ...
            >
              ...
              {item.subject && <p className="text-gray-400">Subject: {item.subject}</p>}
